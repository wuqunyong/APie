...
enum OPCODE_ID : int {
  OP_None = 0,
  OP_DISCOVERY_MSG_REQUEST_REGISTER_INSTANCE = 101,
  ...
  OP_RPC_REQUEST = 301,
  OP_RPC_RESPONSE = 302,
  OP_MSG_REQUEST_ACCOUNT_LOGIN_L = 2000,
  OP_MSG_RESPONSE_ACCOUNT_LOGIN_L = 2001,
  OP_MSG_REQUEST_CLIENT_LOGIN = 3000,
  OP_MSG_RESPONSE_CLIENT_LOGIN = 3001,
  OP_MSG_REQUEST_ECHO = 4002,
  OP_MSG_RESPONSE_ECHO = 4003,
