...
namespace influxdb_cpp {
    ...
    protected:
        ...
        int _send_udp(const std::string& host, int port) {
            ...
            lines_ << '\n';
			std::string sendData = lines_.str();
                        ...
                        switch(chunked) {
                            ...
                            case 0:
                                while(content_length > 0 && !_NO_MORE()) {
									int temp = (int)iv[0].iov_len - len;
									//int minValue = std::min(content_length, temp);
									//iv[1].iov_len = minValue;
									...
									{
										iv[1].iov_len = content_length;
									}
									
                                    content_length -= iv[1].iov_len;
